...
/**
 * @title ArtLinxTokenToken
 * @dev anyone can mint token.
 */
contract MarsIDToken is
    Ownable,
    IERC721,
    IERC721Metadata,
    ERC721Burnable,
...
{
    using Counters for Counters.Counter;
    Counters.Counter public tokensCount;
    ...
    function mint(Fee[] memory _fees, string memory tokenURI)
        public
        returns (uint256 tokenId)
    {
